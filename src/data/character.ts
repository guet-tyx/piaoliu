...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    en: "LUMEN",
    lv: "★ 灯塔守望者",
    image: "/images/lumen-main.png",
    imageAlt: "灯塔守望者「流明」：银白长发蓝瞳，深蓝星空长裙，背景灯塔与星光",
    expressions: [
      { label: "凝视", image: "/images/lumen-expr-gaze.png" },
      { label: "微光", image: "/images/lumen-expr-light.png" },
      { label: "微笑", image: "/images/lumen-expr-smile.png" },
    ],
    tags: [
  ...
  },
  {
    ...
    en: "SOKU",
    lv: "★ 夜航 DJ",
    image: "/images/soku-main.png",
    imageAlt: "夜航 DJ「朔空」：金色短发蓝瞳，白色连帽衫牛仔裤，背景彩色光带",
    expressions: [
      { label: "打碟", image: "/images/soku-expr-dj.png" },
      { label: "沉浸", image: "/images/soku-expr-feel.png" },
      { label: "安利", image: "/images/soku-expr-recommend.png" },
    ],
    tags: [
  ...
  },
  {
    ...
    en: "YOE",
    lv: "★ 星图占卜师",
    image: "/images/yoe-main.png",
    imageAlt: "星图占卜师「悠」：黑色长发紫瞳，紫色长袍内搭黑裙，背景星座图案",
    expressions: [
      { label: "描绘", image: "/images/yoe-expr-draw.png" },
      { label: "凝视", image: "/images/yoe-expr-gaze.png" },
      { label: "指引", image: "/images/yoe-expr-guide.png" },
    ],
    tags: [
